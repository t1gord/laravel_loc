...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Silicon | Portfolio Single Project</title>
...
<main class="page-wrapper">
    ...
    <header class="header navbar navbar-expand-lg bg-light navbar-sticky">
        <div class="container px-3">
            <a href="landing-online-courses.html" class="navbar-brand pe-3">
    ...
    <section class="jarallax" data-jarallax="" data-speed="0.4">
        ...
        <div id="jarallax-container-0" class="jarallax-container" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; z-index: -100; clip-path: polygon(0px 0px, 100% 0px, 100% 100%, 0px 100%);"><div class="jarallax-img" style="background-image: url(&quot;assets/img/portfolio/single/hero.jpg&quot;); object-fit: cover; object-position: 50% 50%; max-width: none; position: fixed; top: 0px; left: 0px; width: 1471.2px; height: 544.4px; overflow: hidden; pointer-events: none; transform-style: preserve-3d; backface-visibility: hidden; margin-top: -85.2px; transform: translate3d(0px, 206.8px, 0px);" data-jarallax-original-styles="background-image: url(assets/img/portfolio/single/hero.jpg);"></div></div></section>
    ...
    <section class="container position-relative pt-1 pt-md-3">
        <div class="row align-items-start">
            <div class="rellax col-lg-5 col-sm-6 mb-4 mb-sm-0" data-rellax-percentage="0.5" data-rellax-speed="-0.5" data-disable-parallax-down="sm" style="transform: translate3d(10px, -88px, 0px);">
                <img src="assets/img/portfolio/single/01.jpg" class="rounded-3" width="526" alt="Image">
            </div>
            <div class="rellax col-lg-7 col-sm-6 d-sm-flex justify-content-end pt-sm-4 pt-lg-5 mt-md-3 mb-4 mb-sm-0" data-rellax-percentage="0.5" data-rellax-speed="-1.25" data-disable-parallax-down="sm" style="transform: translate3d(-15px, -279px, 0px);">
                <div><img src="assets/img/portfolio/single/03.jpg" class="rounded-3" width="416" alt="Image"></div>
            </div>
            <div class="rellax col-lg-5 col-sm-6 d-sm-flex justify-content-lg-end pt-sm-5 mt-lg-5 mb-4 mb-sm-0" data-rellax-percentage="0.5" data-rellax-speed="-1.25" data-disable-parallax-down="sm" style="transform: translate3d(24px, -388px, 0px);">
                <div><img src="assets/img/portfolio/single/04.jpg" class="rounded-3" width="416" alt="Image"></div>
            </div>
            <div class="rellax col-lg-7 col-sm-6 d-sm-flex justify-content-center mt-sm-n5 mb-4 mb-sm-0" data-rellax-percentage="0.5" data-rellax-speed="-0.25" data-disable-parallax-down="sm" style="transform: translate3d(-3px, -61px, 0px);">
        ...
        <div class="row position-sm-absolute top-50 start-0 translate-middle-sm-y w-100 d-flex mt-md-n5">
            <div class="rellax col-lg-5 col-sm-6 offset-sm-3 offset-lg-4 mt-sm-n5" data-rellax-percentage="0.5" data-rellax-speed="1.4" data-disable-parallax-down="sm" style="transform: translate3d(2px, 286px, 0px);">
    ...
    <section class="container py-5 mt-2 mt-md-4 mt-lg-5 mb-xl-2">
        ...
        <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden" data-swiper-options="{
          ...
          &quot;breakpoints&quot;: {
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-55134c5b3df92992" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
